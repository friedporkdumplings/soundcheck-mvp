    ...
    <main className="min-h-screen bg-white px-5 py-6 text-[#183153] sm:px-10 sm:py-10">
      <div className="mx-auto max-w-6xl">
        <header className="sticky top-0 z-40 flex items-center justify-between border-b-2 border-[#193a68] bg-white py-5">
          ...
          <nav className="flex items-center gap-4"><a href="/practice" className="text-xs font-bold tracking-[0.12em] text-[#31577f] uppercase underline decoration-2 underline-offset-4">Ticketing practice</a><a href="#event-library" onClick={(navigationEvent) => { navigationEvent.preventDefault(); setLibraryOpen(true); }} className="text-xs font-bold tracking-[0.12em] text-[#31577f] uppercase underline decoration-2 underline-offset-4">Event library</a><span className="text-xs font-bold tracking-[0.12em] text-[#52739a] uppercase">Your concert brief</span></nav>
        </header>
        ...
        {event && !loading && !demoLoading && <motion.section className="fixed inset-0 z-50 overflow-y-auto bg-white px-5 py-6 text-[#183153] sm:px-10 sm:py-10" variants={containerVariants} initial="hidden" animate="visible" viewport={{ once: true }}><div className="mx-auto max-w-6xl"><OverlayHeader onOpenLibrary={() => setLibraryOpen(true)} /><div className="mt-6 mb-6 flex items-center justify-between border-b-2 border-[#193a68] pb-4"><div><p className="text-xs font-black tracking-[0.14em] text-[#52739a] uppercase">Your concert brief</p><p className="mt-1 text-sm text-[#31577f]">Everything for this show, in one focused view.</p></div><button onClick={() => setEvent(null)} className="border-2 border-[#193a68] bg-white px-4 py-3 text-sm font-black text-[#183153] shadow-[3px_3px_0_#193a68] transition hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[1px_1px_0_#193a68]">← Back to dashboard</button></div>
...
function OverlayHeader({ onOpenLibrary }: { onOpenLibrary: () => void }) { return <header className="sticky top-0 z-40 flex items-center justify-between border-b-2 border-[#193a68] bg-white py-5"><div className="flex items-center gap-3"><span className="h-3 w-3 rounded-full border border-[#193a68] bg-[#8ed1ff]" /><span className="text-sm font-black tracking-[0.22em] text-[#183153] uppercase">Soundcheck</span></div><nav className="flex items-center gap-4"><a href="/practice" className="text-xs font-bold tracking-[0.12em] text-[#31577f] uppercase underline decoration-2 underline-offset-4">Ticketing practice</a><a href="#event-library" onClick={(navigationEvent) => { navigationEvent.preventDefault(); onOpenLibrary(); }} className="text-xs font-bold tracking-[0.12em] text-[#31577f] uppercase underline decoration-2 underline-offset-4">Event library</a><span className="text-xs font-bold tracking-[0.12em] text-[#52739a] uppercase">Your concert brief</span></nav></header>; }
