    ...
    <main className="min-h-screen bg-white px-5 py-6 text-[#183153] sm:px-10 sm:py-10">
      <div className="mx-auto max-w-6xl">
        <header className="flex items-center justify-between border-b-2 border-[#193a68] pb-5">
          ...
          <nav className="flex items-center gap-4"><a href="/practice" className="text-xs font-bold tracking-[0.12em] text-[#31577f] uppercase underline decoration-2 underline-offset-4">Ticketing practice</a><button type="button" onClick={() => setLibraryOpen(true)} className="bg-transparent p-0 text-[12px] leading-none font-bold tracking-[0.12em] text-[#31577f] uppercase underline decoration-2 underline-offset-4">Event library</button><span className="text-xs font-bold tracking-[0.12em] text-[#52739a] uppercase">Your concert brief</span></nav>
        </header>
