  ...
  return (
    <main className="min-h-screen bg-white px-5 py-6 text-[#183153] sm:px-10 sm:py-10">
      <div className="mx-auto max-w-6xl">
        ...
        {event && !loading && !demoLoading && <motion.section className="fixed inset-0 z-50 overflow-y-auto bg-white px-5 py-6 text-[#183153] sm:px-10 sm:py-10" variants={containerVariants} initial="hidden" animate="visible" viewport={{ once: true }}><div className="mx-auto max-w-6xl"><div className="mb-6 flex items-center justify-between border-b-2 border-[#193a68] pb-4"><div><p className="text-xs font-black tracking-[0.14em] text-[#52739a] uppercase">Your concert brief</p><p className="mt-1 text-sm text-[#31577f]">Everything for this show, in one focused view.</p></div><button onClick={() => setEvent(null)} className="border-2 border-[#193a68] bg-white px-4 py-3 text-sm font-black text-[#183153] shadow-[3px_3px_0_#193a68] transition hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[1px_1px_0_#193a68]">← Back to dashboard</button></div>
