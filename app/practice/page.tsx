...
export default function PracticePage() {
  ...
  return <main className="min-h-screen bg-white px-5 py-6 text-[#183153] sm:px-10 sm:py-10"><div className="mx-auto max-w-6xl">
    ...
    {screen === "modes" && <ModeSelect onRush={startRush} onSniper={startSniper} bestRush={bestRush} bestSniper={bestSniper} />}
    ...
    {screen === "rush-result" && <RushResult result={rushResult} target={target} findTime={rushFindTime} queueStart={queueStart} bestRush={bestRush} onAgain={startRush} onModes={() => setScreen("modes")} />}
    {screen === "sniper-countdown" && <StatusCard eyebrow="Seat Sniper" title={sniperCountdown > 0 ? String(sniperCountdown) : "GO"} detail="Hit as many targets as you can in 20 seconds." />}
