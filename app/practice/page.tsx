...
export default function PracticePage() {
  ...
  return <main className="min-h-screen bg-white px-5 py-6 text-[#183153] sm:px-10 sm:py-10"><div className="mx-auto max-w-6xl">
    <header className="sticky top-0 z-40 flex items-center justify-between border-b-2 border-[#193a68] bg-white py-5"><Link href="/" className="flex items-center gap-3"><span className="h-3 w-3 rounded-full border border-[#193a68] bg-[#8ed1ff]" /><span className="text-sm font-black tracking-[0.22em] uppercase">Soundcheck</span></Link><nav className="flex items-center gap-4"><Link href="/practice" className="text-xs font-bold tracking-[0.12em] text-[#31577f] uppercase underline decoration-2 underline-offset-4">Ticketing practice</Link><Link href="/#event-library" className="text-xs font-bold tracking-[0.12em] text-[#31577f] uppercase">Event library</Link><Link href="/" className="text-xs font-bold tracking-[0.12em] text-[#52739a] uppercase">Your concert brief</Link></nav></header>
